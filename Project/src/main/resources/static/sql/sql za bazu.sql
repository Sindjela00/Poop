...
join petice p on k.idkorisnik = p.idcoveka
join cetvorke c on k.idkorisnik = c.idcoveka
join trojke t on k.idkorisnik = t.idcoveka
join dvojke d on k.idkorisnik = d.idcoveka
join jedinice j on k.idkorisnik = j.idcoveka;
